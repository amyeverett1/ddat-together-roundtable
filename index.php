    ...
    <h3><i class="fa fa-calendar fa-lg" aria-hidden="true"></i> <span>Future events</span></h3>
        <div>
            <div class="wrapper">
              ...
              <!--  <ul>
                <li>Croydon - 5 February - Live Services only</li>
